      ...
      <div className="bg-white flex-col sm:w-6/12 lg:w-3/12 mx-auto min-h-2/4 shadow-2xl ring-8 ring-blue-300 ring-opacity-50">
        ...
        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="w-full">
            <p className="w-3/4  tracking-wide  italic mx-auto text-blue-500 leading-relaxed font-trocchi text-lg mt-10">
              username
            </p>
            <input
              type="username"
              className="w-3/4 rounded-b mx-auto pl-3 py-2 font-semibold text-blue-600 placeholder-blue-400 outline-none flex my-5 border-t-3 shadow-md border-blue-500 border-opacity-80 "
              name="name"
          ...
          <div className="w-full">
            ...
            <input
              type="password"
              className="w-3/4 rounded-b shadow-md mx-auto pl-3 py-2  mb-5 font-semibold text-blue-600 placeholder-blue-400  outline-none flex border-t-3 border-blue-500 border-opacity-80"
              name="password"
          ...
          <button
            type="submit"
            className="flex mx-auto outline-none text-white  bg-blue-500 py-2 px-3 rounded border-b-3  border-blue-700 mt-10 font-semibold mb-10 hover:text-blue-200"
          >
            login
          </button>
        </form>
